...
from common.entities import MyMalriqEntity
...
"""
@configure(
    label='To MyMalriqEntity [Hello World]',
    description='Returns a MyMalriqEntity entity with the phrase "Hello Word!"',
    uuids=[ 'malriq.v2.MyMalriqEntityToPhrase_HelloWorld' ],
    inputs=[ ( 'Malriq', Person ) ],
    remote=False,
    debug=True
)
def dotransform(request, response, config):
    ...
    # Create MyMalriqEntity entity with value set to 'Hello <request.value>!'
    e = MyMalriqEntity('Hello %s!' % request.value)
